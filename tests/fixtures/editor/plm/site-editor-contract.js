/* PLM content/bridge contract v1. Shared validation; schema always comes from server registration. */
(function (root, factory) {
  const api = factory();
  if (typeof module === 'object' && module.exports) module.exports = api;
  else root.PlmContentContract = api;
  ...
  return { VERSION, BRIDGE, TYPES, uuid, id, object, exact, same, path, outputPath, safeLink, fail, validateManifest, validateDocument, validateValue, validateValues, diff };
});
